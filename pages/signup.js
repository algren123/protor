    ...
    return (
        <div className="h-screen w-full bg-light-grey flex justify-center items-center">
            <div className="bg-dark-grey text-center w-80 h-120 rounded-md">
                ...
                <button className="bg-primary font-semibold rounded-full px-10 py-1 w-50 mt-3 mb-5" onClick={() => signIn("google", { callbackUrl: "https://protor.uk/"})}>Register with Google</button>
            </div>
        </div>
    )
}
